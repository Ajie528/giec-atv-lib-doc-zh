...
│  │
│  └─1.0.6
│          GIEC-core-en-1.0.6-javadoc.jar
│          GIEC-core-en-1.0.6-sources.jar
│          GIEC-core-en-1.0.6.aar
│          GIEC-core-en-1.0.6.module
│          GIEC-core-en-1.0.6.pom
│
└─GIEC-core-zh
    │  maven-metadata-local.xml
    │
    └─1.0.6
            GIEC-core-zh-1.0.6-javadoc.jar
            GIEC-core-zh-1.0.6-sources.jar
            GIEC-core-zh-1.0.6.aar
            GIEC-core-zh-1.0.6.module
            GIEC-core-zh-1.0.6.pom
```
...
```kotlin
dependencies {
    implementation("com.giec.stb:GIEC-core-zh:1.0.6")
}
```
