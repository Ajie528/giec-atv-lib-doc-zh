...
│  │
│  └─1.0.8
│          GIEC-core-en-1.0.8-javadoc.jar
│          GIEC-core-en-1.0.8-sources.jar
│          GIEC-core-en-1.0.8.aar
│          GIEC-core-en-1.0.8.module
│          GIEC-core-en-1.0.8.pom
│
└─GIEC-core-zh
    │  maven-metadata-local.xml
    │
    └─1.0.8
            GIEC-core-zh-1.0.8-javadoc.jar
            GIEC-core-zh-1.0.8-sources.jar
            GIEC-core-zh-1.0.8.aar
            GIEC-core-zh-1.0.8.module
            GIEC-core-zh-1.0.8.pom
```
...
```kotlin
dependencies {
    implementation("com.giec.stb:GIEC-core-zh:1.0.8")
}
```
