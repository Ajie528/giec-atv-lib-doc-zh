...
│  │
│  └─1.0.12
│          GIEC-core-en-1.0.12-javadoc.jar
│          GIEC-core-en-1.0.12-sources.jar
│          GIEC-core-en-1.0.12.aar
│          GIEC-core-en-1.0.12.module
│          GIEC-core-en-1.0.12.pom
│
└─GIEC-core-zh
    │  maven-metadata-local.xml
    │
    └─1.0.12
            GIEC-core-zh-1.0.12-javadoc.jar
            GIEC-core-zh-1.0.12-sources.jar
            GIEC-core-zh-1.0.12.aar
            GIEC-core-zh-1.0.12.module
            GIEC-core-zh-1.0.12.pom
```
...
```kotlin
dependencies {
    implementation("com.giec.stb:GIEC-core-zh:1.0.12")
}
```
