...
│  │
│  └─1.0.4
│          GIEC-core-en-1.0.4-javadoc.jar
│          GIEC-core-en-1.0.4-sources.jar
│          GIEC-core-en-1.0.4.aar
│          GIEC-core-en-1.0.4.module
│          GIEC-core-en-1.0.4.pom
│
└─GIEC-core-zh
    │  maven-metadata-local.xml
    │
    └─1.0.4
            GIEC-core-zh-1.0.4-javadoc.jar
            GIEC-core-zh-1.0.4-sources.jar
            GIEC-core-zh-1.0.4.aar
            GIEC-core-zh-1.0.4.module
            GIEC-core-zh-1.0.4.pom
```
...
```kotlin
dependencies {
    implementation("com.giec.stb:GIEC-core-zh:1.0.4")
}
```
