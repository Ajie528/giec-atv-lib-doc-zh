...
│  │
│  └─1.0.11
│          GIEC-core-en-1.0.11-javadoc.jar
│          GIEC-core-en-1.0.11-sources.jar
│          GIEC-core-en-1.0.11.aar
│          GIEC-core-en-1.0.11.module
│          GIEC-core-en-1.0.11.pom
│
└─GIEC-core-zh
    │  maven-metadata-local.xml
    │
    └─1.0.11
            GIEC-core-zh-1.0.11-javadoc.jar
            GIEC-core-zh-1.0.11-sources.jar
            GIEC-core-zh-1.0.11.aar
            GIEC-core-zh-1.0.11.module
            GIEC-core-zh-1.0.11.pom
```
...
```kotlin
dependencies {
    implementation("com.giec.stb:GIEC-core-zh:1.0.11")
}
```
